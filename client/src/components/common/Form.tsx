import { Typography, Box, Stack, FormControl, 
         FormHelperText, TextField, TextareaAutosize, 
         Select, MenuItem, Button, borderRadius
  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
        <form style={{ width:"100%", display:"flex", marginTop: "20px", flexDirection: "column", gap: "20px" }} 
        ...
        >
          ...
          <FormControl>
            ...
            <TextareaAutosize 
              ...
              style={{ width: "100%", background: "transparent", color:"#919191", fontSize: "16px", 
          ...
          <Stack direction="row" gap={4}>
            <FormControl sx={{flex:1}}>
              <FormHelperText sx={{fontWeight: 500, margin: "10px 0", 
          ...
          <FormControl>
            ...
            <Stack direction="column" gap={1} justifyContent="center" mb={2}>
              <Stack direction="row" gap={2}>
                <Typography color="#11142d" fontSize={16} fontWeight={500} my="10px">Property Image</Typography>
